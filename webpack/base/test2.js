    ...
    for (let property of Object.keys(data)) {
      if ('[object Object]' === Object.prototype.toString.call(data[property])) {
        ...
        stack.push({
          ...
          origin: {
            // 保留原引用对象，方便修改parent。 origin.obj[origin.pro] ----> parent
            obj: parent,
            pro: property
          }
        })
...
document.getElementById('content')?.addEventListener('click', stackDeepClone)
document.getElementById('content')?.addEventListener('click', creatData(data))
